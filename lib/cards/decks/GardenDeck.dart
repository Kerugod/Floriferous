...
class GardenDeck {
  ...
  void reloadCards() {
    deckGarden = [
      ...
      FLowerCards("Yellow", "Daisy", ""),
      FLowerCards("Yellow", "Daisy", "Bettle"),
      FLowerCards("Yellow", "Lily", ""),
      FLowerCards("Yellow", "Lily", "Ladybug"),
      FLowerCards("Yellow", "Mum", ""),
      FLowerCards("Yellow", "Mum", "Moth"),
      FLowerCards("Yellow", "Poppy", ""),
      FLowerCards("Yellow", "Poppy", "Bee"),
      FLowerCards("Yellow", "Tulip", ""),
      FLowerCards("Yellow", "Tulip", "Butterfly"),
